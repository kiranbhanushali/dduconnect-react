...
export default class The8thVolumeScreen extends Component{
	...
	render(){
		return(
            <View>
                    <ImageBackground style={{width:'100%',height:'100%',justifyContent:'center'}} imageStyle={{width:'100%',resizeMode:'cover'}} source={require('../../assets/images/The_8th_Volume2.jpg')}>
                     
                        
                        <Text style={{color:'#fff',marginTop:100,marginLeft:40,padding:15,shadowRadius:100}}> 
