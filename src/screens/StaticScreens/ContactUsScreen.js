...
import { View, Text, Image, StyleSheet, StatusBar, Linking, TouchableHighlight } from 'react-native';
  ...
  render() {
    return (
      ...
      <View style={{
          ...
          <Text style={{fontFamily:'Montserrat-Bold',fontWeight:'900',marginTop:'5%',fontSize:15}}> Contact Us </Text>
          </Header>     
